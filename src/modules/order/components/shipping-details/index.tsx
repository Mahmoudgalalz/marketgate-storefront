...
const ShippingDetails = ({
  ...
  return (
    <div className="text-base-regular">
      <h2 className="text-base-semi">التوصيل</h2>
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">العنوان</h3>
      ...
      <div className="my-2">
        <h3 className="text-small-regular text-gray-700">خدمة التوصيل</h3>
        <div>
