...
const RefinementList = ({
  ...
  return (
    <div>
      <div className="pl-8 py-4 small:pr-0 small:pl-8 small:min-w-[250px]">
        <div className="flex flex-wrap gap-x-3 pr-8 small:flex-col small:gap-y-3">
          <span className="text-base-semi">التصنيفات</span>
